...
VERIFICATION_ACTION_TEMPLATES: list[dict] = [
    {
        ...
        "cost_usd": 180.0,
        "eta_minutes": 25,
        "justification": "Optimal discriminator between communication blackout and physical structural collapse across road cuts.",
    },
    {
    ...
    },
    {
        ...
        "title_template": "Deploy APF / Nepal Army Forward First-Responder Patrol",
        "target_hypotheses": ["H4", "H5"],
        "info_gain": 0.75,
        "risk_score": 0.70,
        "cost_usd": 300.0,
        "eta_minutes": 90,
        "justification": "Ground truth physical validation of trapped victims and triage demand along accessible arterial roads.",
    },
    {
        "action_type": "lora_iot_probe",
        "title_template": "Activate Emergency LoRa Mesh & Bridge Acoustic Sensor Probe",
        "target_hypotheses": ["H2", "H3"],
        "info_gain": 0.65,
        "risk_score": 0.10,
        "cost_usd": 50.0,
        "eta_minutes": 5,
        "justification": "Instant telemetry handshake to determine whether mountain bridge structure is physically standing.",
    },
    {
        ...
        "cost_usd": 20.0,
        "eta_minutes": 10,
        "justification": "Direct administrative check-in to confirm if civilian evacuation to local open grounds took place.",
    },
]
